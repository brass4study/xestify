...
| ID | Estado | Sev. | Resumen | Commit | Notas |
|---|---|---|---|---|---|
| 07.01 | ⏳ | Crítico | `EntityEdit.submit()` bloquea el formulario tras error (= **P2**) | | |
