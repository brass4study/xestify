 ...
 * PluginClassLoader will discover it by convention: Xestify\plugins\{slug}\Lifecycle.
 *
 * All methods are called by the plugin runtime services at the appropriate moment:
