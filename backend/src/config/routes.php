...
$router->post('/api/v1/plugins/{slug}/move-up', fn(array $params, Request $request) => $container->get(PluginManagerController::class)->movePluginUp($params, $request));
$router->post('/api/v1/plugins/{slug}/move-down', fn(array $params, Request $request) => $container->get(PluginManagerController::class)->movePluginDown($params, $request));
