...
/**
 * Contenedor de inyecci├│n de dependencias minimalista.
 * Zero dependencias externas. Sin autowiring ÔÇö registro expl├¡cito.
 */
class Container
{
     ...
     *
     * @throws InvalidArgumentException Si el servicio no est├í registrado
     */
    ...
    /**
     * Indica si el servicio est├í registrado.
     */
