...
$groups = [
    'unit' => [
        ...
        'backend/tests/unit/OrdersPluginTest.php',
        'backend/tests/unit/InvoicesPluginTest.php',
        'backend/tests/unit/BasicPluginTest.php',
    ...
    'integration-plugins' => [
        ...
        'backend/tests/integration/PluginFieldsConfigTest.php',
        'backend/tests/integration/ReverseRelationTest.php',
        'backend/tests/integration/EntityOptionsTest.php',
        ...
        'backend/tests/integration/PluginOrderServiceTest.php',
